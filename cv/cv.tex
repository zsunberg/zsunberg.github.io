...
\newcommand{\epub}[1]{\refstepcounter{enum}\item[{[\theenum]}] \fullcite{#1}\par\label{#1}}
\newcounter{pnum}
...
\begin{submitted}
\subsection{Submitted Publications (Currently in the review process)}

\begin{itemize}[labelwidth=1cm,leftmargin=1cm,itemsep=0.1em]
\journal{kraske2026robustness}
\journal{dagan2026sensortasking}
\journal{boyer2026explanation}
\journal{monell2026vtwin}
\jc{ventura2026constraint}
\jc{gupta2026edgebundles}
\conf{gupta2026interception}
\end{itemize}
\end{submitted}
...
\mycvitem{2026}{Area chair for Robotics: Science and Systems (RSS) Conference}
