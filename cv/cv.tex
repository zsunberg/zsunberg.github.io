...
% \section{Research}
% 
% \mycventry{January 2020 -- Present}{Director, Autonomous Decision and Control Laboratory}{University of Colorado Boulder}{
%     \vspace{2pt}
%     % storms
%     % tyler
%     % belief-space planning
%     %
%     \cvline{Robot Navigation under Human-induced Uncertainty}{Combining online POMDP tree search with motion planning to improve navigation among pedestrians and other challenges~\cite{gupta2022intention}.}
%     \cvline{Tree Search for Continuous-Space POMDPs}{Developing improved online algorithms for POMDPs with continuous state, action, and observation spaces including visual observations~\cite{lim2021voronoi,deglurkar2022visual}.}
